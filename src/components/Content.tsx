...
export const Content: React.FC = () => {
  ...
  return (
    <div className="mx-5 mt-5 flex min-h-[75vh] flex-col md:flex-row">
      <NavTopics />
      <div className="hide mt-8 inline-block min-h-[1em] w-[1px] self-stretch bg-gray-300 opacity-100 dark:opacity-25"></div>
      {selectedTopicId !== null ? <CreateNote /> : <NotSelectedTopic />}
    </div>
  );
};
